  ...
  return (
    <div className="min-h-screen" data-testid="cursos-page">
      <section className="border-b border-white/10 fd-molecular-bg">
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-10 py-20 md:py-32">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-black uppercase tracking-tighter text-white leading-[0.95] max-w-4xl">
            Cursos para{" "}
            <span className="text-[#CCFF00]">forjar tu mejor versión</span>.
          </h1>
      ...
      <section className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-10 py-14 md:py-20">
        {loading ? (
          <div className="text-center py-20 md:py-32 text-zinc-500 font-mono text-xs sm:text-sm uppercase tracking-widest animate-pulse">
            Cargando cursos destacados...
          </div>
        ) : courses.length === 0 ? (
          <div className="text-center py-20 md:py-32 text-zinc-500 font-mono text-xs sm:text-sm uppercase tracking-widest">
